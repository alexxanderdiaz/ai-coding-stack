...
Works with **Claude Code · Codex · Antigravity · opencode · Cursor · Windsurf · ZAI Code · Kimi** (and any tool that reads `AGENTS.md` natively).
