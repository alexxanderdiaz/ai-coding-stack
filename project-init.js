 ...
 * Cursor, opencode, Windsurf, ZAI Code, Kimi — all read AGENTS.md natively;
 * the cross-tool standard), GEMINI.md (Antigravity-specific pointer),
...
- **"wrapup"**: update \`STATE.md\` fully (Done / In progress / Next / Decisions / Open threads), suggest a commit, confirm. Use before closing. (In Claude Code a Stop hook also writes a git snapshot.)`;
  ...
  console.log(`>> Ready for Claude Code + Codex + Antigravity + opencode + Cursor + Windsurf + ZAI Code + Kimi (AGENTS.md is read by all; CLAUDE.md / GEMINI.md / STATE.md).`);
